...
public class PlayerResourceIntTest {
    ...
    private static final Integer DEFAULT_JERSEY_NUMBER = 1;
    private static final Integer UPDATED_JERSEY_NUMBER = 2;
    ...
    public static Player createEntity(EntityManager em) {
        Player player = new Player()
                ...
                .jerseyNumber(DEFAULT_JERSEY_NUMBER)
    ...
    public void createPlayer() throws Exception {
        ...
        assertThat(testPlayer.getJerseyNumber()).isEqualTo(DEFAULT_JERSEY_NUMBER);
        assertThat(testPlayer.getPositionTitle()).isEqualTo(DEFAULT_POSITION_TITLE);
    }
    ...
    public void getAllPlayers() throws Exception {
        ...
        restPlayerMockMvc.perform(get("/api/players?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].jerseyNumber").value(hasItem(DEFAULT_JERSEY_NUMBER)))
    ...
    public void getPlayer() throws Exception {
        ...
        restPlayerMockMvc.perform(get("/api/players/{id}", player.getId()))
            ...
            .andExpect(jsonPath("$.jerseyNumber").value(DEFAULT_JERSEY_NUMBER))
    ...
    public void updatePlayer() throws Exception {
        ...
        updatedPlayer
                ...
                .jerseyNumber(UPDATED_JERSEY_NUMBER)
        ...
        assertThat(testPlayer.getJerseyNumber()).isEqualTo(UPDATED_JERSEY_NUMBER);
        assertThat(testPlayer.getPositionTitle()).isEqualTo(UPDATED_POSITION_TITLE);
    }
